...
if ($form->ready()) {
    ...
    if (is_null($regalia_needs)) {
        Notifications::printWarningHTML(sprintf(
        ...
        Notifications::printConfirmationHTML(sprintf('This person <strong>%s</strong> own their own regalia', $regalia_needs ? 'does not' : 'does'));
    }
    if ($info) {
